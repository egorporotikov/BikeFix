...
export default function EditMechanicProfilePage() {
    ...
    <main className="min-h-screen bg-slate-50 p-6">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-900">Edit mechanic profile</h1>
            <p className="mt-2 text-slate-600">Update your public mechanic profile and avatar.</p>
          </div>
        </div>
